...
--> statement-breakpoint
INSERT INTO `__new_sales_returns`("id", "created_at", "updated_at", "is_dirty", "is_deleted", "deleted_at", "deleted_by", "shop_id", "sale_id", "sale_item_id", "refund_id", "qty", "reason", "refund_amount", "refund_method", "created_by") SELECT "id", "created_at", "updated_at", "is_dirty", "is_deleted", "deleted_at", "deleted_by", "shop_id", "sale_id", "sale_item_id", "refund_id", "qty", "reason", "refund_amount", "refund_method", "created_by" FROM `sales_returns`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `sales_returns_refund_item_unique` ON `sales_returns` (`refund_id`,`sale_item_id`);