...
// Full-screen loading state for the Muthoy app.
// Soft Green (#ECFDF5) background, animated pill-in-palm mark with dual pulse rings
// and orbiting dots, মুঠোয় wordmark in Mid Gray (#6B7280) + MUTHOY subtitle in brand green.
// Self-contained, offline, respects reduced-motion.

export function MuthoyLoadingScreen() {
  return (
    <div style={{ position: "absolute", inset: 0, background: "#ECFDF5", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <svg width="200" height="236" viewBox="0 0 200 236" role="img" xmlns="http://www.w3.org/2000/svg">
        <title>Muthoy</title>
        <defs>
        ...
        <text x="100" y="208" textAnchor="middle" fontFamily="'Hind Siliguri', sans-serif" fontSize="27" fontWeight="700" fill="#6B7280">মুঠোয়</text>
        <text x="100" y="227" textAnchor="middle" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="11" fontWeight="800" letterSpacing="4" fill="#059669">MUTHOY</text>
      </svg>
    </div>
  );
}
